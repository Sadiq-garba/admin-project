...
<head>
    ...
    <script src="https://kit.fontawesome.com/ca291264d.js" crossorigin="anonymous"></script>
...
<body>
   ...
   <div class="topNav">
    ...
    <div class="main">
        <div class="topContainer row gx-3 mb-3">
            ...
            <div class="col-lg-3">
                <div class="eachContainer">
                    ...
                    <div class="number mt-5 ms-4 fw-bold">{{count($post)}}</div>
    
                    <div class="textWrapper ms-4" >
                        <span>Total Users</span>
                        <span>
                            <img src="./assets/signal 1.png" alt="">
                        </span>
                    </div>
                </div>
            </div>
           ...
           <div class="col-lg-3">
            <div class="eachContainer">
                <div class="iconContainer">
                    <img src="./assets/NEW USER.png" alt="">
                </div>
                <div class="number mt-5  ms-4 fw-bold">{{count($latest)}}</div>
            ...
            <div class="col-lg-3">
                <div class="eachContainer">
                    <div class="iconContainer">
                        <img src="./assets/BANNED USER.png" alt="">
                    </div>
                    <div class="number mt-5  ms-4 fw-bold">{{count($banned)}}</div>
            ...
            <div class="col-lg-3">
                <div class="eachContainer">
                    <div class="iconContainer">
                        <img src="./assets/UNCONFIRMED USER.png" alt="">
                    </div>
                    <div class="number mt-5  ms-4 fw-bold">{{count($unconfirmed)}}</div>
        ...
        <div class="container-fluid smartLogHistory">
                    
            <div class="row gx-3">
               <div class="col-lg-9">
                   <div class="registrationHistory mb-3">
                       <div class="chartHeader">
                           <div class="fw-bold mb-2">Registration History</div>
                           <div>
                               <span class="dateHistory">
                                   <input type="date">
                               </span>
                           </div>
                       </div>
                 ...
                 <div class="col-lg-3">
                   <div class="latestRegistration">
                       <div class="headerReg">
                           <div class="fw-bold">Latest Registration</div>
                           <div class="view fw-bold">View All</div>
                       </div>
                            @if(count($latest) > 0)

                         @foreach($latest as $new)
   
                       <div class="latestUser mb-3">
                           <div class="userImg">
                               <img src="./assets/Portrait_Placeholder.png" alt="">
                           </div>
                           <div class="userDetails">
                               <div class="name fw-bold">{{$new->first_name}}</div>
                               <div class="hours">{{$new->created_at->diffForHumans()}}</div>
                           </div>
                       </div>
